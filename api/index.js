...
// Route
app.post("/api/chat", verifyAppSecret, async (req, res) => {
  try {
    ...
    const completion = await groq.chat.completions.create({
      ...
      // PERBAIKAN DI SINI: Menggunakan model terbaru yang didukung
    ...
    // Menampilkan pesan error yang lebih jelas dari Groq jika terjadi lagi
